...
fetchData();
  ...
  // this is the function which we use to handle the slide of the image scroll using the button which we design
  ...
  // this function will  handle the slide of the internship scroll
  ...
  return (
    <>
      ...
      {/* here we are using the button for scrolling in left or right direction */}
        ...
        <div className="info-intern">
          <div className="mt-16">
            <h1 className="text-center font-bold">
              Latest Internship on InternArea
            </h1>
          </div>
